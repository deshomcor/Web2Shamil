...
namespace Web1Shamil.Controllers
{
    public class CoachesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CoachId,CoachName,CoachSurname")] Coach coach)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CoachId,CoachName,CoachSurname")] Coach coach)
        {
            if (id != coach.CoachId)
            {
                return NotFound();
